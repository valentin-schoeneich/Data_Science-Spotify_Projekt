...
* Ansatz I - Vorhandenes Repository umbauen
  * Umbau
  * Probleme  
* Ansatz II - Libary von mlxtend verwenden
  * Data-Input
  * Die mlxtend Libary
  * Probleme mit mlxtend  
* Ansatz III - Dictionaries verwenden
  * Idee
  * Probleme & Lösungen
* Recommendation
...
2. Regeln der Form x,y -> z generieren  
   ...
   * Die recommendation würde zu "teuer" (zeitaufwendig) werden.
     ...
     Für Regeln der Form a,b,c -> d müsste sogar über `100 * 99 * 98 / (2 * 3) = 161.700` Regeln iteriert werden.
...
2. Nur die Regeln Pname-Track und Track-Track verwenden und dafür mehr Verkettungen zu bilden.
...
### `recommendation()`
In diesem Abschnitt möchten wir die genaue Umsetzung der recommendation erläutern.  
...
Die durchschnittliche Anzahl beträgt 408, der Median 393.
