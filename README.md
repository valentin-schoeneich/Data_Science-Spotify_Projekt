...
Um eine Assoziationsanalyse über unsere Spotify Daten durchzuführen, liegt es
...
Tupel, wie unten dargestellt. Anschließend fügen wir mit der SQL-Funktion `string_agg` die
...
generieren um dann im weiteren Verlauf Regeln für Albums und Artists zu erzeugen.
...
derat ausgelastet, dass das Program mit Swapping beginnen musste. Diesen bequemeren Weg mussten wir
daher verwerfen und letztendlich den Algorithmus mit einigen bereits beschriebenen Vereinfachungen
