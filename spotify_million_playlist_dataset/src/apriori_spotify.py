...
#aprioriSpotify('track_uri', 1000000, minConf=0.2, dbL1ItemSets=False)
#aprioriSpotify('artist_uri', 1000000, minConf=0.2, dbL1ItemSets=False)
aprioriSpotify('album_uri', 1000000, minConf=0.2, dbL1ItemSets=False)
